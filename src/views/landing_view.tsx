...
class LandingView extends Component {
  ...
  showAbout = useAppSelector((state) => state.landing.showAbout)
  showIntro = useAppSelector((state) => state.landing.showIntro)
  showPortfolio = useAppSelector((state) => state.landing.showPortfolio)
  showWork = useAppSelector((state) => state.landing.showWork)
